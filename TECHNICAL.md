...
- [x] **S9 — Session persistence & analytics:** Decision logging, EV tracker, chart decimation.
- [x] **S10 — Frontend (server-rendered):** GGPoker table, control panel, feedback modal, top-bar chart.
